$(document).ready(function() {
  var t = $(".clock").FlipClock({ countdown: !0, clockFace: "MinuteCounter" });
  t.setTime(420), t.start();
}),
  $(document).ready(function() {
    $(document).mousemove(function(t) {
      t.pageY <= 5 && $("#exit-modal").modal("show");
    }),
    ...
    o = (n.constructor = function() {
      if (!Base._prototyping)
        if (this._constructing || this.constructor == o)
          ...
          return (arguments[0].extend || e).call(arguments[0], n);
    });
  return (
    (o.ancestor = this),
      ...
      if (arguments.length > 1) {
        ...
        for (
          var o = { toSource: null },
            ...
            r = Base._prototyping ? 0 : 1;
          (c = a[r++]);

        )
          t[c] != o[c] && s.call(this, c, t[c]);
        for (var c in t) o[c] || s.call(this, c, t[c]);
      }
      return this;
    }
  }),
...
!(function(t) {
  ...
  (FlipClock = function(t, i, e) {
    return (
      i instanceof Object && i instanceof Date == 0 && ((e = i), (i = 0)),
      new FlipClock.Factory(t, i, e)
    );
  }),
    (FlipClock.Lang = {}),
    ...
    FlipClock.Factory = FlipClock.Base.extend({
      ...
      loadClockFace: function(t, i) {
        ...
        return (
          ...
          (e = FlipClock[t]
            ...
            : new FlipClock[this.defaultClockFace + n](this, i)),
          e.build(),
          (this.face = e),
          s && this.start(),
          this.face
      ...
      stop: function(t) {
        ...
        for (var i in this.lists)
          this.lists.hasOwnProperty(i) && this.lists[i].stop();
      },
      reset: function(t) {
  ...
  (function(t) {
    ...
    FlipClock.Time = FlipClock.Base.extend({
      ...
      constructor: function(t, i, e) {
        "object" != typeof e && (e = {}),
          e.minimumDigits || (e.minimumDigits = t.minimumDigits),
          this.base(e),
          (this.factory = t),
          i && (this.time = i);
      },
      ...
      removeLeadingZeros: function(i, e) {
        ...
        return (
          t.each(e, function(t, o) {
            i > t ? (n += parseInt(e[t], 10)) : s.push(e[t]);
          }),
          0 === n ? s : e
        );
      },
    ...
    FlipClock.TwelveHourClockFace = FlipClock.TwentyFourHourClockFace.extend({
      ...
      flip: function(t, i) {
        this.meridiumText != this.getMeridium() &&
          ...
          this.base(this.factory.time.getTime(!1, this.showSeconds), i);
      },
  ...
  $(document).ready(function() {
    ...
    function n() {
      var t = new Date(),
        ...
        a = 6e3;
      for (i = 0; i < 9; i++) {
        var r = Math.random() * (a - o) + o;
        (n += r), (d = new Date(n)), s(d), (o += 700), (a += 700);
      }
      e();
    }
    function s(i) {
      var e = o[Math.floor(Math.random() * o.length)],
        ...
        s = t(i.getHours()) + ":" + t(i.getMinutes()) + ":" + t(i.getSeconds()),
        r = 200 + Math.floor((800 * Math.random()) / 2),
        c =
          "<tr><td>" +
          e +
          "</td><td>$" +
          ...
          "</td><td>" +
          n +
          '</td><td>Won <i class="glyphicon glyphicon-ok" style="color:rgb(69,187,50);"></i> </td></tr>',
        l = ($("#trade-table"), $("#trade-table tr").length);
      if (l >= 10) {
        $("#trade-table tr:last")
          .hide()
          .remove();
        var u = $("#trade-table-body").html(),
          h = c + u;
        $("#trade-table-body").html(h);
      } else $("#trade-table > tbody > tr:first").before(c);
    }
    var o = [
        "Andres",
        "Connie",
    ...
    n(), setInterval(e, 2900 * Math.random() + 1300);
  });
